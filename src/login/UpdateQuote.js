...
class UpdateQuote extends PureComponent {
    ...
    componentDidMount() {
        ...
        this.formRef.current.setFieldsValue({city: 'fffffffffffffffff'});
        this.getServiceData();
    }
    ...
    onOk = () => {
        this.props.form.validateFields((err, values) => {
            ...
            if (!err) {
                ...
                axios.post('http://70.75.134.37:3001/api1/UpdateQuote', {...data}).then((res) => {
                    if (res.data.code === '1') {
...
export default Form.create()(UpdateQuote);