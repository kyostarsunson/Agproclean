  ...
  render() {
    return (
      <div className='footer'>
        ...
        <footer>
          <div class="top">
            <div class="logo">                <img width="45px" src="/logo.avif" alt="" class="logo" /></div>
            <div class="flex"><a href="" class="socialmedia">Facebook</a><a href="" class="socialmedia">Twitter</a><a href="" class="socialmedia">Linkedin</a><a href="" class="socialmedia">Instagram</a></div>
          </div>
